all:
	gcc -I/usr/local/Cellar/libpng/1.6.37/include/libpng16 -L/usr/local/Cellar/libpng/1.6.37/lib -lpng16 main.c functions/general/general_functions.c functions/general/barrier_implementation.c functions/imageProcessing/image_processing.c -o lab2 -lm -Wall -lpng -lpthread
